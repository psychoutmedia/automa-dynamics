...
/**
 * The card image is an actual screenshot of this page, generated by
 * `npm run og`. Without it the route falls back to the site-wide logo, and a
 * link posted to X shows a mark rather than the writing it points at. Every
 * article already advertises its own cover art; this gives the index the same
 * courtesy.
 */
const OG_IMAGE = {
  url: '/articles/og.png',
  width: 2400,
  height: 1260,
  alt: 'Notes on Operational Intelligence - the Automa Dynamics article index',
}
